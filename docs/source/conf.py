...
project = u'Sphinx documentation example'
copyright = u'2021, Xifan Tang'
author = u'Xifan Tang'
...
htmlhelp_basename = 'sphinx_doc_exampledoc'
...
latex_documents = [
    (master_doc, 'sphinx_doc_example.tex', u'Sphinx Example Documentation',
     u'Xifan Tang', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'sphinx_doc_example', u'Sphinx Example Documentation',
     author, 'sphinx_doc_example', 'One line description of project.',
     'Miscellaneous'),
]
